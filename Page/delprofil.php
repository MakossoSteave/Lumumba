...
<script src="https://cdn.jsdelivr.net/npm/uikit@3.5.5/dist/js/uikit-icons.min.js"></script>
    ...
    <div class="card">
  <div class="card-body">
    êtes vous sur de vouloir supprimé votre compte
    <button type="button" class="btn btn-success"><a href="dashboard.php" style=" text-decoration:none;color:white">Non</a></button>
    <button type="button" class="btn btn-danger" id="lids" value="<?= $id?>"  onclick ="suppresionProfile();" > <a  href="index.php" style=" text-decoration:none;color:white"> Oui</a></button>
