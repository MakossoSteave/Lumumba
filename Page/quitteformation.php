...
<script src="https://cdn.jsdelivr.net/npm/uikit@3.5.5/dist/js/uikit-icons.min.js"></script>
    ...
    <div class="card">
  <div class="card-body">
    êtes vous sur de vouloir quitter cette formations ?
    <button type="button" class="btn btn-danger"><a href="dashboard.php" style=" text-decoration:none;color:white">Non</a></button>
    <button type="button" class="btn btn-succes" id="quitteForm" value="<?= $id?>"  onclick ="QuitteForm();" > <a href="dashboard.php" style="text-decoration:none"> Oui</a></button>
